...
![Ukážka fotografie po downscale.](images/own-scene-downscaled-photo.jpg)

![Feature extraction pre vlastnú scénu.](images/colmap-feature-extraction-own-scene.jpg)

![Výsledok vlastnej scény v SIBR Gaussian Viewer.](images/sibr-viewer-own-scene-result.jpg)
...
![Render vlastnej scény z prvého uhla pohľadu.](images/own-scene-render-angle-1.jpg)

![Render vlastnej scény z druhého uhla pohľadu.](images/own-scene-render-angle-2.jpg)
